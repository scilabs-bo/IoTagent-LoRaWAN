...
class AbstractAppService {
     ...
     */
    observeDevice(_devId, _devEUI, _deviceObject) {
        throw new Error('Abstract method.');
    }
     ...
     * @param      {<type>}  _deviceObject  The device object
     */
    stopObservingDevice(_devId, _devEUI, _deviceObject) {
        throw new Error('Abstract method.');
    }
     ...
     */
    async addDevice(devId, devEUI, deviceObject) {
        if (this.devices && this.devices[devId] && this.devices[devId] === deviceObject) {
            ...
            await this.observeDevice(devId, devEUI, deviceObject);
            this.devices[devId] = deviceObject;
        }
    }
     ...
     * @param      {Object}  deviceObject  The device object
     */
    async removeDevice(devId, devEUI, deviceObject) {
        await this.stopObservingDevice(devId, devEUI, deviceObject);
    ...
    getDeviceByEui(devEui) {
        if (this.devices) {
            for (const deviceKey in this.devices) {
                if (Object.prototype.hasOwnProperty.call(this.devices, deviceKey)) {
